      ...
      content: [
        {
          ...
          text: "On the next page we will tell you what documents you'll need to apply",
          condition: 'my condition'
        },
        {
        ...
        {
          title: 'Apply online',
          text: "Take as long as you need to finish, but if you're inactive for 20 minutes your application will time out",
          condition: ''
        },
        {
          title: 'Pay online',
        ...
        },
        {
          ...
          text: "After you've completed your online application you need to take a statutory declaration at the Consulate. We will give you the option to go to the Consulate at Lisbon or Portimão and we will send you a link to book your appointment.",
          condition: ''
        },
        {
          title: 'Check and print your declaration',
          text: 'Your declaration will be emailed to you. Check the details are correct, then print it off but do not sign it. Take it to your appointment at the Consulate.',
          condition: ''
        },
        {
          title: 'Take your documents to Portuguese customs ',
          text: 'Take your vehicle importation letter and signed statutory declaration to Portuguese customs.',
          condition: ''
        }
      ]
    })
